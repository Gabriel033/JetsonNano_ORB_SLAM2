    ...
    mbFinishRequested(false), mbFinished(true), mbStopped(true), mbStopRequested(false)
{
    ...
    mViewpointF = fSettings["Viewer.ViewpointF"];
    // For Save Map
    mInitLocalizationMode = bOnlyTracking;
}
...
void Viewer::Run()
{
    ...
    pangolin::Var<bool> menuShowGraph("menu.Show Graph",false,true);    // king true
    pangolin::Var<bool> menuLocalizationMode("menu.Localization Mode",mInitLocalizationMode,true);   // false, true
    ...
    while(1)
    {
        ...
        // menuLocalizationMode: user set mode; bLocalizationMode: // current mode
        if(menuLocalizationMode && !bLocalizationMode)
        {
            //test
            std::cout << "ActivateLocalizationMode" << std::endl;
            mpSystem->ActivateLocalizationMode();
            bLocalizationMode = true;   // current mode
        }
        else if(!menuLocalizationMode && bLocalizationMode)
        {
            //test
            std::cout << "DeactivateLocalizationMode" << std::endl;
        ...
        if(menuReset)
        {
            ...
            menuShowPoints = true;
            // king
            menuLocalizationMode = mInitLocalizationMode;
