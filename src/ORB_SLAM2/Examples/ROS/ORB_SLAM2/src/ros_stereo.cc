...
int main(int argc, char **argv)
{
    ...
    ORB_SLAM2::System SLAM(argv[1],argv[2],ORB_SLAM2::System::STEREO,true, bool(std::string(argv[5]) == "true"));
    /*******Load Map*********/
    ...
    ros::Publisher PosPub = nh.advertise<geometry_msgs::PoseStamped>("ORB_SLAM2/pose", 5); // Pose publisher
        igb.pPosPub = &(PosPub); //
    ros::Publisher OdomPub = nh.advertise<nav_msgs::Odometry>("ORB_SLAM2/odom", 5); //Odometry publisher
